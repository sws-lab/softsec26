...
// Contract: both methods return floor((a + b) / 2) computed over mathematical
// integers, without overflowing the 32-bit Java int sum. average1 already
// meets it; average2 does not yet.
public final class Average {
    ...
    // The efficient version under test: it should compute the same result using
